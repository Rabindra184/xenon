        ...
        <div className="settings-container mesh-gradient-infra">
            <div className="settings-header">
                ...
                <p className="settings-subtitle">
                    Manage the lifecycle of test artifacts, automated purging schedules, and storage optimization across the global registry.
                </p>
            </div>
            ...
            <div className="settings-content">
                <div className="settings-grid">
                    ...
                    >
                        ...
                        <div className="setting-hint-clean">Standard enterprise retention is typically 30-90 days.</div>
                    </SettingSection>
                    ...
                    >
                        ...
                        <div className="setting-hint-clean">Protects against database bloat during high-frequency CI bursts.</div>
                    </SettingSection>
                    ...
                    >
                        <div className="toggle-group">
                            ...
                            <span className="toggle-label">{config.deleteBuildAssets ? 'ENABLED' : 'DISABLED'}</span>
                        </div>
                        <div className="setting-hint-clean">Disabling this will leave orphaned files on disk—use with caution.</div>
                    </SettingSection>
                ...
                <div className="health-monitor-alert" style={{ background: 'rgba(59, 130, 246, 0.05)', borderColor: 'rgba(59, 130, 246, 0.2)', color: '#60a5fa', marginTop: '1.5rem' }}>
                    <Info size={18} />
                    <span>
                        <strong>Resource Notice:</strong> Bulk purging operations are non-blocking and execute at low priority to ensure zero interference with active test execution.
                    </span>
                </div>
