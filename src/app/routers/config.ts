        ...
        configRouter.put('/', async (req, res) => {
            ...
            try {
                ...
                res.json({
                    ...
                    message: 'Configuration updated. Some changes may require a server restart to take full effect.'
                });
            } catch (err: any) {
...
function checkRestartRequired(newConfig: Partial<IPluginArgs>): boolean {
    ...
    const RESTART_KEYS = ['hub', 'platform', 'bindHostOrIp', 'proxy', 'cloud', 'iosDeviceType', 'androidDeviceType'];
